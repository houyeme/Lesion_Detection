try:
    ...
    checkpoint_path = "training_1/cpVGG16Take3.ckpt"
    def vgg16():
    ...
    #model=tf.keras.models.load_model('training_1/VGG16tModeltake3')
        ...
        with st.container():
            ...
            with left_column:
                ...
                if isinstance(file, BytesIO):
                    ...
                    resized_image2 = np.asarray(pil_image.open(file).resize((120,90)))
